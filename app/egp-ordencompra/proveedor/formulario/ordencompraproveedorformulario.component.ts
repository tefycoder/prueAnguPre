...
export class OrdenCompraProveedorFormularioComponent implements OnInit, AfterViewInit {
  ...
  RechazarOC(event) {
    ...
    swal({
      ...
      let nav = ['/egp-ordencompra/proveedor/buscar'];
  ...
  ngAfterViewInit() {
    ...
    swal({
      text: "La OC/OS ha sido Visualizada. Se informará al Comprador de la Visualización. Si dentro de un periodo de 24 horas la OC/OS no ha sido aceptada o rechazada, esta pasará a ser aceptada de manera automática. ",
      type: 'warning',
      buttonsStyling: false,
