...
import {Recuperardatos} from 'app/model/recuperardatos';
declare var $:any;
...
export class NuevaContrasenaComponent implements OnInit, OnChanges, AfterViewInit {
  test : Date = new Date();
