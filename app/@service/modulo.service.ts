...
export class ModuloService {
  ...
  constructor(
    ...
    private httpClient: HttpClient
      ...
      this.administracionTopic.Topic = 'modulo';
  }

  public obtenerListaModulo(arrayParams:any){
    return this.http.get(URI_ADMIN_LISTA + 'modulo/', this.header.getOptions(arrayParams))
  ...
  public obtenerModuloPorId(id: string ): Observable <Modulo> {
    return this.http
      .get(URI_ADMIN_LISTA + 'modulo/' + id, this.header.getOptions([]))
      .map(this.extractData)
      .catch(this.handleError);
  }

  public crearModulo(modulo: Modulo) {
    this.administracionTopic.Objeto = modulo;
