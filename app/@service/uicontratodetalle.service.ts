...
@Injectable()
export class UiContratoDetalleService {
  ...
  constructor(
    ...
    private httpClient: HttpClient
      ...
      this.administracionTopic.Topic = 'uicontratodetalle';
  }
  
  public crearUiModuloUrlBoton(uiContratoDetalle: UiContratoDetalle) {
    this.administracionTopic.Objeto = uiContratoDetalle;
    return this.http.post(URI_ADMIN_CREAR, this.administracionTopic, this.header.getOptions([]))
      .catch(this.handleError);
  }

  public editarUiModuloUrlBoton(uiContratoDetalle: UiContratoDetalle) {
    this.administracionTopic.Objeto = uiContratoDetalle;
