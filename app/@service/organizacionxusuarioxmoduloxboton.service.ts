...
@Injectable()
export class OrganizacionXUsuarioXModuloXBotonService {
  ...
  constructor(
    ...
    private httpClient: HttpClient
      ...
      this.administracionTopic.Topic = 'organizacionxusuarioxmoduloxboton';
  }

  public obtenerListaGrupoEmpresarial(arrayParams:any){
    return this.http.get(URI_ADMIN_LISTA + 'organizacionxusuarioxmoduloxboton/', this.header.getOptions(arrayParams))
